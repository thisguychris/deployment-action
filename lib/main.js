...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield client.repos.createDeploymentStatus(Object.assign({}, context.repo, { deployment_id: deployment.data.id, state: initialStatus, log_url: defaultUrl, target_url: url, environment_url: url }));
